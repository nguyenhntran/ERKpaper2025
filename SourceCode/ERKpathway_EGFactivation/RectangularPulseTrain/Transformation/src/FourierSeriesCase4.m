...
% |                                                                     |
% | Inputs:                                                             |
% | TransFuncCase4_ClassTf.mat                                          |  %<--- filename
% |                                                                     |
% | Outputs:                                                            |
% | Transformation_Case4.pdf                                            |  %<--- filename
% | OutputStats_Case4.txt                                               |  %<--- filename
%  ---------------------------------------------------------------------
...
tl = tiledlayout(2,1);
title(tl,'Input-output transformation: High amplitude pulses at frequency 1/3780 s$^{-1}$', 'Interpreter','latex') %<--- title case number
...
load('../../TransferFunction/data/TransFuncCase4_ClassTf.mat')             %<--- filename
...
% Define output
ERKstar_equilibrium = 0.222756196134773;                                   %<--- equilibrium output obtained from timecourse similation of nonlinear model
...
% fileID = fopen('../data/OutputStats_Case4.txt','w');                       %<--- case number
% 
% % Print stats
% fprintf(fileID, "CASE 4 ERK* OUTPUT: \n\n");                               %<--- case number
