...
% | OutputFourierExpansion_Case1.mat                                    |  %<--- filename
%  ---------------------------------------------------------------------
...
tl = tiledlayout(2,1);
title(tl,'Input-output transformation: Triangular pulses at frequency $6.981\times10^{-3}$ (rad/s)', 'Interpreter','latex') %<--- title case number
...
periodduration = 900; %seconds                                             %<--- pulse period
...
ylim([0.1975 0.1983])                                                        %<--- y axis limits
