...
% | OutputFourierExpansion_Case3.mat                                    |  %<--- filename
%  ---------------------------------------------------------------------
...
tl = tiledlayout(2,1);
title(tl,'Input-output transformation: Triangular pulses at frequency $1.745\times10^{-3}$ (rad/s)', 'Interpreter','latex') %<--- title case number
...
periodduration = 3600; %seconds                                            %<--- pulse period
...
ylim([0.1965 0.199])                                                        %<--- y axis limits
