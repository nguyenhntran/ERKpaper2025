...
%|SUMMARY:                                                                |
%|                                                                        |
%|Compare ERK* outputs for all cases of NGF triangular pulse train inputs.|
% ------------------------------------------------------------------------
...
% ----- Plot responses due to NGF triangular pulse train input -----
...
title('ERK* Output Responses to NGF Triangular Pulse Train Inputs', 'Interpreter','latex')
