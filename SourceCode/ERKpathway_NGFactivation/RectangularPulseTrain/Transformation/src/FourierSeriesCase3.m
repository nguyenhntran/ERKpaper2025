...
tl = tiledlayout(2,1);
title(tl,'Input-output transformation: High amplitude pulses at frequency $4.553\times10^{-2}$ (rad/s)', 'Interpreter','latex') %<--- title case number
...
% Define output
ERKstar_equilibrium = 0.253870180846027;                                   %<--- equilibrium output obtained from timecourse similation of nonlinear model
