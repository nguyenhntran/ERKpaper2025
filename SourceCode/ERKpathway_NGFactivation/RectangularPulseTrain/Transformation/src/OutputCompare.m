...
%|SUMMARY:                                                                |
%|                                                                        |
%|Compare ERK* outputs for all cases of NGF rectangular pulse train       |
%|inputs.                                                                 |
% ------------------------------------------------------------------------
...
tl = tiledlayout(2,1);
title(tl,'ERK* Output Responses to NGF Rectangular Pulse Train Inputs', 'Interpreter','latex')
xlabel(tl,'Time (s)', 'Interpreter','latex')
ylabel(tl,'Concentration (unitless)', 'Interpreter','latex')

% ----- Plot responses due to high NGF rectangular pulse train input -----
...
title('Low NGF' ,'Interpreter','latex')
