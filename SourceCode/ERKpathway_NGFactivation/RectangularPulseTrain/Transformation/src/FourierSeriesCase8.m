...
tl = tiledlayout(2,1);
title(tl,'Input-output transformation: Low amplitude pulses at frequency $1.662\times10^{-3}$ (rad/s)', 'Interpreter','latex') %<--- title case number
...
amplitude = 2/26; %unitless concentration                                  %<--- pulse amplitude
...
% Define output
ERKstar_equilibrium = 0.0236378414792461;                                  %<--- equilibrium output obtained from timecourse similation of nonlinear model
