...
tl = tiledlayout(2,1);
title(tl,'Input-output transformation: High amplitude pulses at frequency $1.662\times10^{-3}$ (rad/s)', 'Interpreter','latex') %<--- title case number
...
% Define output
ERKstar_equilibrium = 0.220834613663765;                                   %<--- equilibrium output obtained from timecourse similation of nonlinear model
