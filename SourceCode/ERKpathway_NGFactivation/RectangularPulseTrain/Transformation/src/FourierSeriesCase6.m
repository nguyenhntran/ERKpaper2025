...
tl = tiledlayout(2,1);
title(tl,'Input-output transformation: Low amplitude pulses at frequency $8.055\times10^{-3}$ (rad/s)', 'Interpreter','latex') %<--- title case number
...
% Define output
ERKstar_equilibrium = 0.101971789214450;                                   %<--- equilibrium output obtained from timecourse similation of nonlinear model
