...
tl = tiledlayout(2,1);
title(tl,'Input-output transformation: Low amplitude pulses at frequency $1.745\times10^{-2}$ (rad/s)', 'Interpreter','latex') %<--- title case number
...
% Define output
ERKstar_equilibrium = 0.159039598281569;                                   %<--- equilibrium output obtained from timecourse similation of nonlinear model
