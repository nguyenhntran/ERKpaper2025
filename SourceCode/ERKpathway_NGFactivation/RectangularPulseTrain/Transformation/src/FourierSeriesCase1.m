...
tl = tiledlayout(2,1);
title(tl,'Input-output transformation: High amplitude pulses at frequency $1.745\times10^{-2}$ (rad/s)', 'Interpreter','latex') %<--- title case number
...
% Define output
ERKstar_equilibrium = 0.215068549870597;                                   %<--- equilibrium output obtained from timecourse similation of nonlinear model
