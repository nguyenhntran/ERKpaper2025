...
% |                                                                     |
% | Inputs:                                                             |
% | TransFuncCase2_ClassTf.mat                                          |  %<--- filename
% |                                                                     |
% | Outputs:                                                            |
...
tl = tiledlayout(2,1);
title(tl,'Input-output transformation: High amplitude pulses at frequency 1/780 s$^{-1}$', 'Interpreter','latex') %<--- title case number
...
% Define output
ERKstar_equilibrium = 0.209511208901993;                                   %<--- equilibrium output obtained from timecourse similation of nonlinear model
